    ...
    if (currentLocation < maxLocation) {
        switch (currentLocation) {
            ...
            case 5:
                ...
                paper6.style.zIndex = 27;
                break;
            case 7:
                paper7.classList.add("flipped");
                paper7.style.zIndex = 28;
                break;
            case 8:
            ...
            case 11:
                ...
                paper11.style.zIndex = 32;
                break;
            case 12:
                paper12.classList.add("flipped");
                paper12.style.zIndex = 33;
                break;
            case 13:
                paper13.classList.add("flipped");
                paper13.style.zIndex = 34;
                break;
                case 14:
                paper14.classList.add("flipped");
                paper14.style.zIndex = 35;
                break;
            case 15:
            ...
            case 16:
                ...
                paper16.style.zIndex = 37;
                break;
            case 17:
                paper17.classList.add("flipped");
                paper17.style.zIndex = 38;
                break;
                case 18:
                paper18.classList.add("flipped");
                paper18.style.zIndex = 39;
                break;
            case 19:
                paper19.classList.add("flipped");
                paper19.style.zIndex = 40;
                break;
                case 20:
    ...
    if (currentLocation > 1) {
        switch (currentLocation) {
            ...
            case 4:
                ...
                paper3.style.zIndex =22;
                break;
            case 5:
                paper4.classList.remove("flipped");
                paper4.style.zIndex = 21;
                break;
            case 6:
