  ...
  // let dxg = document.getElementById('dxg-container');
  // let nutmeg = document.getElementById('nutmeg-container');
  // let personal = document.getElementById('personal-container');
  // let dxgTitle = document.getElementById('dxg-title');
  // let nutmegTitle = document.getElementById('nutmeg-tile');
  // let personalTitle = document.getElementById('personal-title');
  // let fallingSnow = document.getElementById('snow');
  // let snowflake = '';
  ...
  //   snowflake.className = 'snow-ball';
  //   fallingSnow.appendChild(snowflake);
  //   d = Math.random() * 100
  //   h = Math.random() * 8;
  //   v = Math.random() * 6 + 3;
  //   x = Math.random() * innerWidth
  //   snowflake.style.width = h + "px"
  //   snowflake.style.height = h + "px"
  //   snowflake.style.opacity = d + "%";
  //   snowflake.style.right = x + "px";
  //   snowflake.style.animation = `fall ${v}s linear infinite`
  // }

  // function drift() {
  //   snowflake.style.right = x + 100 + 'px';
  // }
